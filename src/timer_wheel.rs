...
mod tests {
    ...
    fn event_timing() {
        ...
        for j in 0..128 {
            ...
            let slot = wheel.schedule(&(start + Duration::from_millis(n_millis as u64)), n_millis);
            //println!("n_millis= {}, slot = {}", n_millis, slot);
        }

        for i in 0..1024 { // proceed with roughly 2 ms ticks
